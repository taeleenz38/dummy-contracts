...
export default async () => {
    ...
    async function getValue(context, variable, isDevKeystore, onlyAllowDevKeystore) {
        ...
        if (!(await keystore.hasKey(variable.name, masterKey))) {
            if (onlyAllowDevKeystore) {
                throw new HardhatError(HardhatError.ERRORS.HARDHAT_KEYSTORE.GENERAL.KEY_NOT_FOUND_DURING_TESTS_WITH_DEV_KEYSTORE, {
                    key: variable.name,
                });
            }
            return undefined;
